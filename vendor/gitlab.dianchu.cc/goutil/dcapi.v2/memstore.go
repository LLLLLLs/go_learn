...
func (e Entry) IntDefault(def int) (int, error) {
	v := e.ValueRaw
	if v == nil {
		return def, formatErr(errFindParse, "int", e.Key)
	}
	if vint, ok := v.(int); ok {
		return vint, nil
...
func (e Entry) Int64Default(def int64) (int64, error) {
	v := e.ValueRaw
	if v == nil {
		return def, formatErr(errFindParse, "int64", e.Key)
	}
...
func (e Entry) Float64Default(def float64) (float64, error) {
	...
	if v == nil {
		return def, formatErr(errFindParse, "float64", e.Key)
	}
...
func (e Entry) Float32Default(key string, def float32) (float32, error) {
	...
	if v == nil {
		return def, formatErr(errFindParse, "float32", e.Key)
	}
...
func (e Entry) BoolDefault(def bool) (bool, error) {
	v := e.ValueRaw
	if v == nil {
		return def, formatErr(errFindParse, "bool", e.Key)
	}
...
func (r *Store) GetInt(key string) (int, error) {
	v := r.GetEntry(key)
	if v == nil {
		return 0, formatErr(errFindParse, "int", key)
	}
...
func (r *Store) GetInt64(key string) (int64, error) {
	v := r.GetEntry(key)
	if v == nil {
		return -1, formatErr(errFindParse, "int64", key)
	}
...
func (r *Store) GetFloat64(key string) (float64, error) {
	v := r.GetEntry(key)
	if v == nil {
		return -1, formatErr(errFindParse, "float64", key)
	}
...
func (r *Store) GetBool(key string) (bool, error) {
	v := r.GetEntry(key)
	if v == nil {
		return false, formatErr(errFindParse, "bool", key)
	}
...
func formatErr(e string, a ...interface{}) error {
	return errors.New(fmt.Sprintf(e, a...))
}
